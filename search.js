...
const iconBackTo = document.querySelector('.icon-back-top');

iconBackTo.addEventListener('click', () => {
    window.scrollTo(0, 0);
    iconBackTo.classList.remove('d-flex');
...
window.addEventListener('scroll', () => {
    ...
    if (scrollTop > lastScrollPos) {
        iconBackTo.classList.add('d-flex');
    }
